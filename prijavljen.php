                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-10">
                                                                                <input class="form-control" type="text" value="" id="serv_agr">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
